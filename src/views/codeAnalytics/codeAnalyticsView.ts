...
import { NPlusSpansListViewItemsCreator, SpanDurationsListViewItemsCreator, SpanEndpointBottlenecksListViewItemsCreator, SpanUsagesListViewItemsCreator, ChildSpanDurationsListViewItemsCreator , ChildrenSpanDurationsListViewItemsCreator } from "./InsightListView/SpanInsight";
...
{  
	...
	constructor(
        ...
        listViewItemsCreator.add("ChildSpanDurations", new ChildSpanDurationsListViewItemsCreator(this._webViewUris));
