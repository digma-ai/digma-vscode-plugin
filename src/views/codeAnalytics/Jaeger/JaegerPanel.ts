...
export class JaegerPanel {
  ...
  public getHtml(traceIds: string[], traceIdLabels :string[]|undefined, span: string, jaegerAddress: string, jaegerUri: vscode.Uri): string {
    ...
    <head>
      ...
      <link href="${staticPath}/css/main.c4c1b0e0.chunk.css" rel="stylesheet">
    </head>
    ...
    <body>
      ...
      <script src="${staticPath}/js/1.a4fc9687.chunk.js"></script>
      <script src="${staticPath}/js/main.1c93c471.chunk.js"></script>
    </body>
