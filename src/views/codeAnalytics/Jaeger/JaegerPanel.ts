...
export class JaegerPanel {
  ...
  public getHtml(traceIds: string[], traceIdLabels :string[]|undefined, span: string, jaegerAddress: string, jaegerUri: vscode.Uri): string {
    ...
    <head>
      ...
      <link href="${staticPath}/css/main.e6eba539.chunk.css" rel="stylesheet">
    </head>
    ...
    <body>
      ...
      <script src="${staticPath}/js/1.18c0d657.chunk.js"></script>
      <script src="${staticPath}/js/main.486339a4.chunk.js"></script>
    </body>
