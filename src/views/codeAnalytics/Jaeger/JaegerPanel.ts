...
export class JaegerPanel {
  ...
  public getHtml(traceIds: string[], traceIdLabels :string[]|undefined, span: string, jaegerAddress: string, jaegerUri: vscode.Uri): string {
    ...
    <head>
      ...
      <link href="${staticPath}/css/main.5d63a928.chunk.css" rel="stylesheet">
    </head>
    ...
    <body>
      ...
      <script src="${staticPath}/js/1.d3152fe5.chunk.js"></script>
      <script src="${staticPath}/js/main.76011d61.chunk.js"></script>
    </body>
