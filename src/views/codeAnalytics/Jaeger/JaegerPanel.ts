...
export class JaegerPanel {
  ...
  public getHtml(traceIds: string[], traceIdLabels :string[]|undefined, span: string, jaegerAddress: string, jaegerUri: vscode.Uri): string {
    ...
    <head>
      ...
      <link href="${staticPath}/css/1.0c35af5e.chunk.css" rel="stylesheet">
      <link href="${staticPath}/css/main.29cf1ebb.chunk.css" rel="stylesheet">
    </head>
    ...
    <body>
      ...
      <script src="${staticPath}/js/1.ca4b2595.chunk.js"></script>
      <script src="${staticPath}/js/main.24bdac36.chunk.js"></script>
    </body>
